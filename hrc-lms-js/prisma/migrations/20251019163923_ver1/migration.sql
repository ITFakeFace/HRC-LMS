...
CREATE TABLE `Course` (
    ...
    `courseObjectives` JSON NOT NULL,
    `targetLearners` JSON NULL,
    `courseDuration` JSON NOT NULL,
...
-- AddForeignKey
ALTER TABLE `Course` ADD CONSTRAINT `Course_lastEditor_fkey` FOREIGN KEY (`lastEditor`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
